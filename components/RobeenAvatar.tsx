      ...
      >
        <defs>
          ...
          <linearGradient id="hairGradient" x1="20" y1="20" x2="180" y2="180" gradientUnits="userSpaceOnUse">
            ...
            <stop offset="60%" stopColor="#4338CA"/> {/* Indigo 700 */}
        ...
        <ellipse cx="100" cy="160" rx="15" ry="5" fill="#D4A88E" /> {/* Neck Shadow */}

        {/* --- Shoulders / Clothing --- */}
        <path d="M50 200 C 50 175 70 160 100 160 C 130 160 150 175 150 200" fill="url(#clothesGradient)" />
        <path d="M100 160 L 90 175 H 110 L 100 160" fill="white" opacity="0.3" /> {/* Collar Detail */}
